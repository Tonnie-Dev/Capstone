package com.androidshowtime.representative.adapter
...
import com.androidshowtime.databinding.RepItemBinding
import com.androidshowtime.network.models.Channel
...
class RepresentativeListAdapter() : ListAdapter<Representative,
    ...
    override fun onBindViewHolder(holder: RepresentativeViewHolder, position: Int) {
        ...
        holder.itemView.animation = loadAnimation(holder.itemView.context, R.anim
            .my_anims)
        holder.bind(item)
    }
}
